...
#> Chain 2 (Warmup): ⦗━━━━━╺━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 260/2000 (13.0%)
#> Total   (Warmup): ⦗━━━━━╺━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 510/4000 (12.8%)
#> Elapsed: 4s | ETA: 27s
...
#> Total   (Warmup): ⦗━━━━━━━━━━━╺━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1104/4000 (27.6%)
#> Elapsed: 5s | ETA: 13s
#> Chain 1 (Warmup): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 700/2000 (35.0%)
#> Chain 2 (Warmup): ⦗━━━━━━━━━━━━━━╺━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 717/2000 (35.9%)
#> Total   (Warmup): ⦗━━━━━━━━━━━━━━╺━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1417/4000 (35.4%)
#> Elapsed: 5s | ETA: 9s
#> Chain 1 (Warmup): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 850/2000 (42.5%)
#> Chain 2 (Warmup): ⦗━━━━━━━━━━━━━━━━━╺━━━━━━━━━━━━━━━━━━━━━━⦘ 862/2000 (43.1%)
#> Total   (Warmup): ⦗━━━━━━━━━━━━━━━━━╺━━━━━━━━━━━━━━━━━━━━━━⦘ 1712/4000 (42.8%)
#> Elapsed: 6s | ETA: 8s
...
#> 2    loose_ends-entertain (pairwise) 0.0180 0.1329511 0.003088804
#> 3   loose_ends-repetitive (pairwise) 0.0380 0.1911962 0.005587051
#> 4  loose_ends-stimulation (pairwise) 0.2200 0.4142463 0.029987115
#> 5    loose_ends-motivated (pairwise) 0.0295 0.1692033 0.005264833
#> 6                   entertain (main) 1.0000 0.0000000          NA
#> 7    entertain-repetitive (pairwise) 0.0270 0.1620833 0.004623018
#> 8   entertain-stimulation (pairwise) 0.1945 0.3958153 0.023940913
#> 9     entertain-motivated (pairwise) 0.0575 0.2327955 0.008927402
#> 10                 repetitive (main) 1.0000 0.0000000          NA
#> 11 repetitive-stimulation (pairwise) 0.0255 0.1576380 0.004386558
#> 12   repetitive-motivated (pairwise) 0.0235 0.1514851 0.003854318
#> 13                stimulation (main) 1.0000 0.0000000          NA
#> 14  stimulation-motivated (pairwise) 0.0295 0.1692033 0.007347741
#> 15                  motivated (main) 1.0000 0.0000000          NA
#>    n0->0 n0->1 n1->0 n1->1     n_eff     Rhat
#> 1      0     0     0  1999        NA       NA
#> 2   1929    34    34     2 1852.6918 1.013364
#> 3   1869    54    54    22 1171.0985 1.002729
#> 4   1500    59    60   380  190.8306 1.001204
#> 5   1901    39    39    20 1032.8765 1.023712
#> 6      0     0     0  1999        NA       NA
#> 7   1905    40    40    14 1229.2083 1.002309
#> 8   1535    76    75   313  273.3403 1.009867
#> 9   1829    55    55    60  679.9845 1.006247
#> 10     0     0     0  1999        NA       NA
#> 11  1909    39    39    12 1291.4399 1.004399
#> 12  1912    40    40     7 1544.7029 1.010683
#> 13     0     0     0  1999        NA       NA
#> 14  1916    24    24    35  530.2856 1.011303
#> 15     0     0     0  1999        NA       NA

# Bayesian model averaged main effects for the groups
coef(fit)$main_effects_groups
#>                      group1     group2
#> loose_ends(c1)  -0.94683052 -0.9119481
#> loose_ends(c2)  -2.73855420 -2.2370726
#> loose_ends(c3)  -4.00178677 -3.5430920
#> loose_ends(c4)  -5.30227603 -4.8212973
#> loose_ends(c5)  -7.60229983 -7.4008250
#> loose_ends(c6)  -9.83493485 -9.9328252
#> entertain(c1)   -0.75336522 -1.0465681
#> entertain(c2)   -2.20191995 -2.2848280
#> entertain(c3)   -4.00087080 -3.7010955
#> entertain(c4)   -5.07511177 -5.1962906
#> entertain(c5)   -7.05636862 -6.9993778
#> entertain(c6)   -9.71115785 -9.4890112
#> repetitive(c1)  -0.04891009 -0.2825988
#> repetitive(c2)  -0.49719548 -0.9129131
#> repetitive(c3)  -1.02561549 -1.1305339
#> repetitive(c4)  -1.96174504 -1.7233450
#> repetitive(c5)  -3.56105474 -2.9596848
#> repetitive(c6)  -5.28002479 -4.6741486
#> stimulation(c1) -0.35115908 -0.8606964
#> stimulation(c2) -1.76271014 -1.8586173
#> stimulation(c3) -2.44316298 -2.6822970
#> stimulation(c4) -3.42526444 -3.8586787
#> stimulation(c5) -5.05599893 -5.2984276
#> stimulation(c6) -6.72964181 -7.4065647
#> motivated(c1)   -0.45964556 -0.7040672
#> motivated(c2)   -1.74082652 -1.8716337
#> motivated(c3)   -3.42239169 -3.1547768
#> motivated(c4)   -5.04756411 -4.5843112
#> motivated(c5)   -6.62564164 -6.6931717
#> motivated(c6)   -9.29419699 -8.8988965

# Bayesian model averaged pairwise effects for the groups
coef(fit)$pairwise_effects_groups
#>                            group1     group2
#> loose_ends-entertain   0.16954263 0.16969514
#> loose_ends-repetitive  0.05595140 0.05691082
#> loose_ends-stimulation 0.12226665 0.13312652
#> loose_ends-motivated   0.14022114 0.13956711
#> entertain-repetitive   0.06440654 0.06491066
#> entertain-stimulation  0.10445969 0.11316451
#> entertain-motivated    0.08445552 0.08668548
#> repetitive-stimulation 0.05625111 0.05674660
#> repetitive-motivated   0.13460525 0.13500735
#> stimulation-motivated  0.10725648 0.10789230
# }
```
