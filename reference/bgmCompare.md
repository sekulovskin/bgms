...
#> Elapsed: 5s | ETA: 3m 13s
#> Chain 1 (Warmup): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 100/2000 (5.0%)
#> Chain 2 (Warmup): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 100/2000 (5.0%)
#> Total   (Warmup): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 200/4000 (5.0%)
#> Elapsed: 11s | ETA: 3m 29s
#> Chain 1 (Warmup): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 150/2000 (7.5%)
#> Chain 2 (Warmup): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 140/2000 (7.0%)
#> Total   (Warmup): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 290/4000 (7.2%)
#> Elapsed: 12s | ETA: 2m 33s
#> Chain 1 (Warmup): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 200/2000 (10.0%)
#> Chain 2 (Warmup): ⦗━━━╺━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 152/2000 (7.6%)
#> Total   (Warmup): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 352/4000 (8.8%)
#> Elapsed: 13s | ETA: 2m 14s
#> Chain 1 (Warmup): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 300/2000 (15.0%)
#> Chain 2 (Warmup): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 297/2000 (14.8%)
#> Total   (Warmup): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 597/4000 (14.9%)
#> Elapsed: 16s | ETA: 1m 31s
#> Chain 1 (Warmup): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 400/2000 (20.0%)
#> Chain 2 (Warmup): ⦗━━━━━━━━╺━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 404/2000 (20.2%)
#> Total   (Warmup): ⦗━━━━━━━━╺━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 804/4000 (20.1%)
#> Elapsed: 17s | ETA: 1m 7s
...
#> Total   (Warmup): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1198/4000 (29.9%)
#> Elapsed: 19s | ETA: 44s
#> Chain 1 (Warmup): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 700/2000 (35.0%)
#> Chain 2 (Warmup): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 700/2000 (35.0%)
#> Total   (Warmup): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1400/4000 (35.0%)
#> Elapsed: 20s | ETA: 37s
#> Chain 1 (Warmup): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 800/2000 (40.0%)
#> Chain 2 (Warmup): ⦗━━━━━━━━━━━━━━━━╺━━━━━━━━━━━━━━━━━━━━━━━⦘ 801/2000 (40.1%)
#> Total   (Warmup): ⦗━━━━━━━━━━━━━━━━╺━━━━━━━━━━━━━━━━━━━━━━━⦘ 1601/4000 (40.0%)
#> Elapsed: 20s | ETA: 30s
#> Chain 1 (Warmup): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 850/2000 (42.5%)
#> Chain 2 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1178/2000 (58.9%)
#> Total   (Warmup): ⦗━━━━━━━━━━━━━━━━━━━━╺━━━━━━━━━━━━━━━━━━━⦘ 2028/4000 (50.7%)
#> Elapsed: 24s | ETA: 23s
#> Chain 1 (Warmup): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 900/2000 (45.0%)
#> Chain 2 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━╺━━━━━━━━━━━━━⦘ 1314/2000 (65.7%)
#> Total   (Warmup): ⦗━━━━━━━━━━━━━━━━━━━━━━╺━━━━━━━━━━━━━━━━━⦘ 2214/4000 (55.4%)
#> Elapsed: 25s | ETA: 20s
#> Chain 1 (Warmup): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 950/2000 (47.5%)
#> Chain 2 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1432/2000 (71.6%)
#> Total   (Warmup): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 2382/4000 (59.6%)
#> Elapsed: 25s | ETA: 17s
#> Chain 1 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1050/2000 (52.5%)
#> Chain 2 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╺━━━━━━━━⦘ 1569/2000 (78.5%)
#> Total   (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━╺━━━━━━━━━━━━━⦘ 2619/4000 (65.5%)
#> Elapsed: 26s | ETA: 14s
#> Chain 1 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1150/2000 (57.5%)
#> Chain 2 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1690/2000 (84.5%)
#> Total   (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━╺━━━━━━━━━━━⦘ 2840/4000 (71.0%)
#> Elapsed: 27s | ETA: 11s
#> Chain 1 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1250/2000 (62.5%)
#> Chain 2 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1833/2000 (91.6%)
#> Total   (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 3083/4000 (77.1%)
#> Elapsed: 28s | ETA: 8s
#> Chain 1 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1350/2000 (67.5%)
#> Chain 2 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╺⦘ 1958/2000 (97.9%)
#> Total   (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╺━━━━━━⦘ 3308/4000 (82.7%)
#> Elapsed: 29s | ETA: 6s
...
#> 2    loose_ends-entertain (pairwise) 0.0160 0.003135779 0.1254751
#> 3   loose_ends-repetitive (pairwise) 0.0275 0.004460278 0.1635352
#> 4  loose_ends-stimulation (pairwise) 0.3045 0.028013104 0.4601953
#> 5    loose_ends-motivated (pairwise) 0.0290 0.004686385 0.1678064
#> 6                   entertain (main) 1.0000          NA 0.0000000
#> 7    entertain-repetitive (pairwise) 0.0215 0.003407378 0.1450440
#> 8   entertain-stimulation (pairwise) 0.1780 0.020195962 0.3825127
#> 9     entertain-motivated (pairwise) 0.0555 0.007470776 0.2289536
#> 10                 repetitive (main) 1.0000          NA 0.0000000
#> 11 repetitive-stimulation (pairwise) 0.0285 0.005361439 0.1663964
#> 12   repetitive-motivated (pairwise) 0.0265 0.004084062 0.1606168
#> 13                stimulation (main) 1.0000          NA 0.0000000
#> 14  stimulation-motivated (pairwise) 0.0275 0.004130731 0.1635352
#> 15                  motivated (main) 1.0000          NA 0.0000000
#>    n0->0 n0->1 n1->0 n1->1 n_eff_mixt      Rhat
#> 1      0     0     0  1999         NA        NA
#> 2   1939    28    28     4  1601.1213 1.0169178
#> 3   1901    43    43    12  1344.3069 1.0195145
#> 4   1290   100   101   508   269.8746 0.9997657
#> 5   1897    44    44    14  1282.1574 1.0091723
#> 6      0     0     0  1999         NA        NA
#> 7   1916    40    40     3  1812.0015 1.0019784
#> 8   1554    89    89   267   358.7259 1.0028714
#> 9   1821    67    67    44   939.2117 1.0090866
#> 10     0     0     0  1999         NA        NA
#> 11  1906    36    36    21   963.2188 1.0009233
#> 12  1901    45    45     8  1546.6683 0.9996827
#> 13     0     0     0  1999         NA        NA
#> 14  1897    47    47     8  1567.3593 1.0130185
#> 15     0     0     0  1999         NA        NA

# Bayesian model averaged main effects for the groups
coef(fit)$main_effects_groups
#>                      group1     group2
#> loose_ends(c1)  -0.94400444 -0.9148556
#> loose_ends(c2)  -2.73463724 -2.2371556
#> loose_ends(c3)  -3.99776030 -3.5565492
#> loose_ends(c4)  -5.29227420 -4.8373339
#> loose_ends(c5)  -7.58524832 -7.4376062
#> loose_ends(c6)  -9.81246426 -9.9712493
#> entertain(c1)   -0.74626467 -1.0354537
#> entertain(c2)   -2.19824782 -2.2745964
#> entertain(c3)   -3.99481441 -3.6833556
#> entertain(c4)   -5.07611595 -5.1591720
#> entertain(c5)   -7.03246337 -6.9595885
#> entertain(c6)   -9.71360070 -9.4490121
#> repetitive(c1)  -0.05065388 -0.2729769
#> repetitive(c2)  -0.49916521 -0.9115109
#> repetitive(c3)  -1.03474595 -1.1325442
#> repetitive(c4)  -1.96724381 -1.7230141
#> repetitive(c5)  -3.56988119 -2.9584819
#> repetitive(c6)  -5.30253637 -4.6698861
#> stimulation(c1) -0.35222406 -0.8618020
#> stimulation(c2) -1.75776146 -1.8602789
#> stimulation(c3) -2.44342003 -2.6899613
#> stimulation(c4) -3.42570430 -3.8816603
#> stimulation(c5) -5.04668530 -5.3301322
#> stimulation(c6) -6.71125574 -7.4393657
#> motivated(c1)   -0.45822653 -0.7063547
#> motivated(c2)   -1.73809516 -1.8689019
#> motivated(c3)   -3.40930370 -3.1551550
#> motivated(c4)   -5.04851368 -4.5754521
#> motivated(c5)   -6.61706562 -6.6812666
#> motivated(c6)   -9.29466514 -8.8964812

# Bayesian model averaged pairwise effects for the groups
coef(fit)$pairwise_effects_groups
#>                            group1     group2
#> loose_ends-entertain   0.16918889 0.16924760
#> loose_ends-repetitive  0.05637852 0.05710018
#> loose_ends-stimulation 0.12003510 0.13590097
#> loose_ends-motivated   0.14029288 0.13970785
#> entertain-repetitive   0.06439224 0.06479375
#> entertain-stimulation  0.10511006 0.11298167
#> entertain-motivated    0.08391174 0.08569176
#> repetitive-stimulation 0.05619373 0.05690244
#> repetitive-motivated   0.13445248 0.13491101
#> stimulation-motivated  0.10749255 0.10790328
# }
```
