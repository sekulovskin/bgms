...
#> Elapsed: 2s | ETA: 1m 13s
#> Chain 1 (Warmup): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 100/2000 (5.0%)
#> Chain 2 (Warmup): ⦗━━╺━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 106/2000 (5.3%)
#> Total   (Warmup): ⦗━━╺━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 206/4000 (5.1%)
#> Elapsed: 4s | ETA: 1m 13s
#> Chain 1 (Warmup): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 200/2000 (10.0%)
#> Chain 2 (Warmup): ⦗━━━━╺━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 221/2000 (11.1%)
#> Total   (Warmup): ⦗━━━━╺━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 421/4000 (10.5%)
#> Elapsed: 5s | ETA: 43s
#> Chain 1 (Warmup): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 350/2000 (17.5%)
#> Chain 2 (Warmup): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 376/2000 (18.8%)
#> Total   (Warmup): ⦗━━━━━━━╺━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 726/4000 (18.1%)
#> Elapsed: 6s | ETA: 27s
#> Chain 1 (Warmup): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 500/2000 (25.0%)
#> Chain 2 (Warmup): ⦗━━━━━━━━━━╺━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 522/2000 (26.1%)
#> Total   (Warmup): ⦗━━━━━━━━━━╺━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1021/4000 (25.5%)
#> Elapsed: 6s | ETA: 18s
...
#> Total   (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 2961/4000 (74.0%)
#> Elapsed: 11s | ETA: 4s
#> Chain 1 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1600/2000 (80.0%)
#> Chain 2 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╺━━━━━━⦘ 1673/2000 (83.7%)
#> Total   (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 3273/4000 (81.8%)
#> Elapsed: 12s | ETA: 3s
#> Chain 1 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1750/2000 (87.5%)
#> Chain 2 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1828/2000 (91.4%)
#> Total   (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 3578/4000 (89.5%)
#> Elapsed: 12s | ETA: 1s
#> Chain 1 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1900/2000 (95.0%)
#> Chain 2 (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 1985/2000 (99.2%)
#> Total   (Sampling): ⦗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⦘ 3884/4000 (97.1%)
#> Elapsed: 13s | ETA: 0s
...
#> 2    loose_ends-entertain (pairwise) 0.0155 0.1235304 0.003101431
#> 3   loose_ends-repetitive (pairwise) 0.0320 0.1760000 0.004551859
#> 4  loose_ends-stimulation (pairwise) 0.2430 0.4288951 0.026187477
#> 5    loose_ends-motivated (pairwise) 0.0260 0.1591352 0.004315177
#> 6                   entertain (main) 1.0000 0.0000000          NA
#> 7    entertain-repetitive (pairwise) 0.0200 0.1400000 0.003870951
#> 8   entertain-stimulation (pairwise) 0.1750 0.3799671 0.021131848
#> 9     entertain-motivated (pairwise) 0.0450 0.2073041 0.007136968
#> 10                 repetitive (main) 1.0000 0.0000000          NA
#> 11 repetitive-stimulation (pairwise) 0.0305 0.1719586 0.005278888
#> 12   repetitive-motivated (pairwise) 0.0305 0.1719586 0.006451760
#> 13                stimulation (main) 1.0000 0.0000000          NA
#> 14  stimulation-motivated (pairwise) 0.0145 0.1195397 0.003507465
#> 15                  motivated (main) 1.0000 0.0000000          NA
#>    n0->0 n0->1 n1->0 n1->1     n_eff      Rhat
#> 1      0     0     0  1999        NA        NA
#> 2   1941    27    27     4 1586.4380 1.0042229
#> 3   1882    53    53    11 1495.0223 1.0119097
#> 4   1426    87    87   399  268.2346 1.0112634
#> 5   1906    41    41    11 1359.9881 1.0258641
#> 6      0     0     0  1999        NA        NA
#> 7   1928    31    31     9 1308.0390 1.0045652
#> 8   1569    81    80   269  323.3084 1.0720807
#> 9   1858    51    51    39  843.7007 1.0018239
#> 10     0     0     0  1999        NA        NA
#> 11  1897    41    41    20 1061.1159 0.9996385
#> 12  1907    31    31    30  710.3808 1.0159107
#> 13     0     0     0  1999        NA        NA
#> 14  1949    21    21     8 1161.5501 1.1399921
#> 15     0     0     0  1999        NA        NA

# Bayesian model averaged main effects for the groups
coef(fit)$main_effects_groups
#>                      group1     group2
#> loose_ends(c1)  -0.95192269 -0.9106350
#> loose_ends(c2)  -2.73884348 -2.2390455
#> loose_ends(c3)  -4.00475069 -3.5452480
#> loose_ends(c4)  -5.31065413 -4.8267330
#> loose_ends(c5)  -7.60797238 -7.4116188
#> loose_ends(c6)  -9.83147948 -9.9330020
#> entertain(c1)   -0.75193913 -1.0336229
#> entertain(c2)   -2.19527655 -2.2675572
#> entertain(c3)   -3.99157650 -3.6738460
#> entertain(c4)   -5.05517805 -5.1504058
#> entertain(c5)   -7.03974837 -6.9466499
#> entertain(c6)   -9.69426492 -9.4214496
#> repetitive(c1)  -0.05363541 -0.2796506
#> repetitive(c2)  -0.50383499 -0.9160569
#> repetitive(c3)  -1.03976596 -1.1393606
#> repetitive(c4)  -1.97186238 -1.7388806
#> repetitive(c5)  -3.57589980 -2.9817332
#> repetitive(c6)  -5.30493924 -4.7004292
#> stimulation(c1) -0.35749271 -0.8667788
#> stimulation(c2) -1.76825189 -1.8681106
#> stimulation(c3) -2.45761720 -2.6995368
#> stimulation(c4) -3.44046532 -3.8808820
#> stimulation(c5) -5.07445591 -5.3239854
#> stimulation(c6) -6.74238984 -7.4331231
#> motivated(c1)   -0.45801738 -0.7076508
#> motivated(c2)   -1.74615098 -1.8761490
#> motivated(c3)   -3.42318401 -3.1649755
#> motivated(c4)   -5.05618307 -4.5912801
#> motivated(c5)   -6.63994135 -6.7000250
#> motivated(c6)   -9.31585370 -8.9115985

# Bayesian model averaged pairwise effects for the groups
coef(fit)$pairwise_effects_groups
#>                            group1     group2
#> loose_ends-entertain   0.16839457 0.16853363
#> loose_ends-repetitive  0.05671728 0.05740377
#> loose_ends-stimulation 0.12228973 0.13428714
#> loose_ends-motivated   0.13989525 0.13934954
#> entertain-repetitive   0.06419841 0.06466672
#> entertain-stimulation  0.10458032 0.11225555
#> entertain-motivated    0.08441852 0.08581665
#> repetitive-stimulation 0.05654297 0.05726982
#> repetitive-motivated   0.13523477 0.13589579
#> stimulation-motivated  0.10808877 0.10833420
# }
```
