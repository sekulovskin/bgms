...
sample_omrf_gibbs <- function(no_states, no_variables, no_categories, interactions, thresholds, iter, initial_values) {
    .Call(`_bgms_sample_omrf_gibbs`, no_states, no_variables, no_categories, interactions, thresholds, iter, initial_values)
}
