...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const std::string& >::type update_method_interactions(update_method_interactionsSEXP);
    Rcpp::traits::input_parameter< const std::string& >::type update_method_thresholds(update_method_thresholdsSEXP);
    Rcpp::traits::input_parameter< const arma::imat >::type pairwise_effect_indices(pairwise_effect_indicesSEXP);
    Rcpp::traits::input_parameter< const double >::type target_accept_thresholds(target_accept_thresholdsSEXP);
    Rcpp::traits::input_parameter< const double >::type target_accept_interactions(target_accept_interactionsSEXP);
    rcpp_result_gen = Rcpp::wrap(run_gibbs_sampler_for_bgm(observations, num_categories, interaction_scale, edge_prior, inclusion_probability, beta_bernoulli_alpha, beta_bernoulli_beta, dirichlet_alpha, lambda, interaction_index_matrix, iter, burnin, num_obs_categories, sufficient_blume_capel, threshold_alpha, threshold_beta, na_impute, missing_index, is_ordinal_variable, reference_category, save_main, save_pairwise, save_indicator, display_progress, edge_selection, update_method_interactions, update_method_thresholds, pairwise_effect_indices, target_accept_thresholds, target_accept_interactions));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_bgms_run_gibbs_sampler_for_bgm", (DL_FUNC) &_bgms_run_gibbs_sampler_for_bgm, 30},
